                        ...
                        <div class="mt-4">
                            ...
                            <div class="bg-white p-4 border rounded-lg flex justify-center">
                                <?php if (strpos($qrCode, 'data:image') === 0): ?>
                                    ...
                                    <img src="<?php echo $qrCode; ?>" alt="WhatsApp QR Code" class="max-w-full h-auto">
                                <?php else: ?>
                                    <!-- Tampilkan iframe untuk URL API -->
                                    <div class="text-center p-4">
                                        ...
                                        <div class="border rounded-lg overflow-hidden" style="height: 300px;">
                                            <iframe src="<?php echo $qrCode; ?>" frameborder="0" style="width: 100%; height: 100%;"></iframe>
                                        </div>
